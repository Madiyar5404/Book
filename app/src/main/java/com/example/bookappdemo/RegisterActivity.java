...
import com.example.bookappdemo.databinding.ActivityRegisterBinding;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void validateData() {
        ...
        if (TextUtils.isEmpty(name)){
            ...
            Toast.makeText(this,"Please doesn't match...",Toast.LENGTH_SHORT).show();
        }
        else{
            createUserAccount();
        }
    ...
    private void updateUserInfo() {
        ...
        //set data to DB
        DatabaseReference ref= FirebaseDatabase.getInstance().getReference("Users"); //child-Получить ссылку на местоположение относительно этого
        ref.child(uid)
                .setValue(hashMap)
