...
import com.example.bookappdemo.databinding.ActivityPdfAddBinding;
...
public class PdfAddActivity extends AppCompatActivity {
        ...
        storageReference.putFile(pdfUri)
                ...
                .addOnFailureListener(new OnFailureListener() {
                    ...
                    public void onFailure(@NonNull Exception e) {
                        ...
                        Toast.makeText(PdfAddActivity.this,"Pdf upload due to "+e.getMessage(),Toast.LENGTH_SHORT).show();
                    }
                });
    ...
    private void uploadPDfInfoToDB(String uploadedPdfUrl, long timestamp) {
        //Step 3:Upload PDF info to firebase
    ...
    private void loadPdfCategories() {
        ...
        //df reference to load categories... db => Categories
